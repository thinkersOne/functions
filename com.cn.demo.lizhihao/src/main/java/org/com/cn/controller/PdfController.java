...
public class PdfController {
    ...
    public String previewHtmlObj() throws IOException, TemplateException {
        LongTermContractDTO longTermContractDTO = generatorPDFObj();
...
//        表格内容
    ...
    public LongTermContractDTO generatorPDFObj() {
        //开始组装数据并返回html
...
//        表格内容
        ...
        longTermContractDTO.setPurchaserPhone("13585865081");
        longTermContractDTO.setSignTime("20200529");
